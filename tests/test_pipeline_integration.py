...
class TestConstantsZoneClassCoverage:
    ...
    EXPECTED_ZONE_CLASSES: frozenset[str] = frozenset({
        # Business (-1.5 and -5 variants appear in ArcGIS; same use permissions within type)
        "B1-1", "B1-1.5", "B1-2", "B1-3", "B1-5",
        "B2-1", "B2-1.5", "B2-2", "B2-3", "B2-5",
        "B3-1", "B3-1.5", "B3-2", "B3-3", "B3-5",
        # Commercial (-5 and C1-1.5 variants appear in ArcGIS; same use permissions within type)
        "C1-1", "C1-1.5", "C1-2", "C1-3", "C1-5",
        "C2-1", "C2-2", "C2-3", "C2-5",
        "C3-1", "C3-2", "C3-3", "C3-5",
        # Residential (RT-4A appears in ArcGIS; same use permissions as RT-4)
        "RS-1", "RS-2", "RS-3",
        "RT-3.5", "RT-4", "RT-4A",
        ...
        "M2-1", "M2-2", "M2-3",
        "M3-1", "M3-2", "M3-3",
        # Downtown (DX-10 is codified in §17-4-0100; DS-7 appears in ArcGIS with DS permissions)
        "DC-12", "DC-16",
        "DX-3", "DX-5", "DX-7", "DX-10", "DX-12", "DX-16",
